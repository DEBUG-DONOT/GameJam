	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput vert ( VertexInput v  )
			{
				...
				float mulTime3_g13 = _TimeParameters.x * _WindSpeed_Instance;
				float2 temp_cast_0 = (( ase_worldPos.x + mulTime3_g13 )).xx;
				float simplePerlin2D33_g13 = snoise( temp_cast_0*0.1 );
				...
				float4 transform1_g13 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				float temp_output_4_0_g13 = ( transform1_g13.x * transform1_g13.y );
				float4 _WindMapping_Instance = UNITY_ACCESS_INSTANCED_PROP(HandPainted2DSpriteWind,_WindMapping);
				float2 temp_cast_1 = (( ase_worldPos.y + mulTime3_g13 )).xx;
				float simplePerlin2D27_g13 = snoise( temp_cast_1*0.1 );
				float3 appendResult40_g13 = (float3(( ( simplePerlin2D33_g13 * _WindNoise_Instance ) + ( ( ( _WindSway_Instance * sin( ( mulTime3_g13 + temp_output_4_0_g13 ) ) ) * (0.0 + (v.vertex.xyz.y - _WindMapping_Instance.x) * (1.0 - 0.0) / (_WindMapping_Instance.y - _WindMapping_Instance.x)) ) * step( 0.05 , ( abs( _WindMapping_Instance.x ) + abs( _WindMapping_Instance.y ) ) ) ) ) , ( ( _WindNoise_Instance * simplePerlin2D27_g13 ) + ( ( ( _WindSway_Instance * cos( ( mulTime3_g13 + temp_output_4_0_g13 ) ) ) * (0.0 + (v.vertex.xyz.x - _WindMapping_Instance.z) * (1.0 - 0.0) / (_WindMapping_Instance.w - _WindMapping_Instance.z)) ) * step( 0.05 , ( abs( _WindMapping_Instance.z ) + abs( _WindMapping_Instance.w ) ) ) ) ) , 0.0));
				...
				#endif
				float3 vertexValue = appendResult40_g13;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
        ...
        Pass
        {
			...
			VertexOutput vert(VertexInput v )
			{
				...
				float2 temp_cast_1 = (( ase_worldPos.y + mulTime3_g13 )).xx;
				float simplePerlin2D27_g13 = snoise( temp_cast_1*0.1 );
				float3 appendResult40_g13 = (float3(( ( simplePerlin2D33_g13 * _WindNoise_Instance ) + ( ( ( _WindSway_Instance * sin( ( mulTime3_g13 + temp_output_4_0_g13 ) ) ) * (0.0 + (v.vertex.y - _WindMapping_Instance.x) * (1.0 - 0.0) / (_WindMapping_Instance.y - _WindMapping_Instance.x)) ) * step( 0.05 , ( abs( _WindMapping_Instance.x ) + abs( _WindMapping_Instance.y ) ) ) ) ) , ( ( _WindNoise_Instance * simplePerlin2D27_g13 ) + ( ( ( _WindSway_Instance * cos( ( mulTime3_g13 + temp_output_4_0_g13 ) ) ) * (0.0 + (v.vertex.x - _WindMapping_Instance.z) * (1.0 - 0.0) / (_WindMapping_Instance.w - _WindMapping_Instance.z)) ) * step( 0.05 , ( abs( _WindMapping_Instance.z ) + abs( _WindMapping_Instance.w ) ) ) ) ) , 0.0));
...
Node;AmplifyShaderEditor.FunctionNode;160;1548.321,1025.227;Inherit;False;WindSprite;1;;13;97e1bfadcd8a346f08e4f26c39db68a1;0;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;162;1913.951,984.0372;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;199187dac283dbe4a8cb1ea611d70c58;True;ScenePickingPass;0;4;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;5;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;ShaderGraphShader=true;True;0;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;True;0;True;12;all;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;161;1913.951,984.0372;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;199187dac283dbe4a8cb1ea611d70c58;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;5;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;ShaderGraphShader=true;True;0;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;True;0;True;12;all;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=FFAB99D5B49FE61F617415759F89BD71037F9DAE