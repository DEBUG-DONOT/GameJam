	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_output_26_0_g16 = appendResult102;
				float4 blendOpSrc17_g16 = _ForegroundColor;
				float4 blendOpDest17_g16 = temp_output_26_0_g16;
				float clampResult10_g16 = clamp( positionWS.z , _ForegroundRange.y , _ForegroundRange.x );
				float4 lerpBlendMode17_g16 = lerp(blendOpDest17_g16,( blendOpSrc17_g16 * blendOpDest17_g16 ),(1.0 + (clampResult10_g16 - _ForegroundRange.y) * (0.0 - 1.0) / (_ForegroundRange.x - _ForegroundRange.y)));
				float temp_output_3_0_g16 = step( _ForegroundRange.x , positionWS.z );
				float clampResult6_g16 = clamp( positionWS.z , _BackgroundRange.x , _BackgroundRange.y );
				float4 lerpResult4_g16 = lerp( temp_output_26_0_g16 , _BackgroundColor , ( 1.0 - pow( ( 1.0 - (0.0 + (clampResult6_g16 - _BackgroundRange.x) * (1.0 - 0.0) / (_BackgroundRange.y - _BackgroundRange.x)) ) , 2.0 ) ));
				float4 break23_g16 = ( ( ( saturate( lerpBlendMode17_g16 )) * ( 1.0 - temp_output_3_0_g16 ) ) + ( temp_output_3_0_g16 * lerpResult4_g16 ) );
				float4 appendResult24_g16 = (float4(break23_g16.r , break23_g16.g , break23_g16.b , temp_output_26_0_g16.a));
				#ifdef _FOG_ON
				float4 staticSwitch31 = appendResult24_g16;
				#else
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 blendOpSrc17_g16 = _ForegroundColor;
				float4 blendOpDest17_g16 = temp_output_26_0_g16;
				float clampResult10_g16 = clamp( ase_worldPos.z , _ForegroundRange.y , _ForegroundRange.x );
				float4 lerpBlendMode17_g16 = lerp(blendOpDest17_g16,( blendOpSrc17_g16 * blendOpDest17_g16 ),(1.0 + (clampResult10_g16 - _ForegroundRange.y) * (0.0 - 1.0) / (_ForegroundRange.x - _ForegroundRange.y)));
				float temp_output_3_0_g16 = step( _ForegroundRange.x , ase_worldPos.z );
				float clampResult6_g16 = clamp( ase_worldPos.z , _BackgroundRange.x , _BackgroundRange.y );
				float4 lerpResult4_g16 = lerp( temp_output_26_0_g16 , _BackgroundColor , ( 1.0 - pow( ( 1.0 - (0.0 + (clampResult6_g16 - _BackgroundRange.x) * (1.0 - 0.0) / (_BackgroundRange.y - _BackgroundRange.x)) ) , 2.0 ) ));
				float4 break23_g16 = ( ( ( saturate( lerpBlendMode17_g16 )) * ( 1.0 - temp_output_3_0_g16 ) ) + ( temp_output_3_0_g16 * lerpResult4_g16 ) );
				float4 appendResult24_g16 = (float4(break23_g16.r , break23_g16.g , break23_g16.b , temp_output_26_0_g16.a));
				#ifdef _FOG_ON
...
Node;AmplifyShaderEditor.FunctionNode;192;1270.47,662.7758;Inherit;False;Fog;5;;16;0af4f8e64e08f404a8159464b51699d5;0;1;26;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;194;1808.78,957.7532;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;199187dac283dbe4a8cb1ea611d70c58;True;ScenePickingPass;0;4;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;5;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;ShaderGraphShader=true;True;0;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;True;0;True;12;all;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;193;1808.78,957.7532;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;199187dac283dbe4a8cb1ea611d70c58;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;5;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;ShaderGraphShader=true;True;0;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;True;0;True;12;all;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=4BD1CFAEFC9CE48B8B2DE2FF215BB5C7EC080C63